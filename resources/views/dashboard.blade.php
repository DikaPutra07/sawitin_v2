...
@section('content')
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="flex justify-between items-center">
                ...
                <button class="flex items-center px-3.5 py-2 bg-green-500 text-white rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-filter"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>
                    <span>Filter</span>
                </button>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4 mt-4">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <div class="flex items-center py-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mr-0.5 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sprout mr-2"><path d="M7 20h10"/><path d="M10 20c5.5-2.5.8-6.4 3-10"/><path d="M9.5 9.4c1.1.8 1.8 2.2 2.3 3.7-2 .4-3.5.4-4.8-.3-1.2-.6-2.3-1.9-3-4.2 2.8-.5 4.4 0 5.5.8z"/><path d="M14.1 6a7 7 0 0 0-1.1 4c1.9-.1 3.3-.6 4.3-1.4 1-1 1.6-2.3 1.7-4.6-2.7.1-4 1-4.9 2z"/></svg>
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    <p class="text-black font-semibold">Total Tanaman Sehat</p>
                    <div class="flex items-center py-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mr-0.5 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sprout mr-2"><path d="M7 20h10"/><path d="M10 20c5.5-2.5.8-6.4 3-10"/><path d="M9.5 9.4c1.1.8 1.8 2.2 2.3 3.7-2 .4-3.5.4-4.8-.3-1.2-.6-2.3-1.9-3-4.2 2.8-.5 4.4 0 5.5.8z"/><path d="M14.1 6a7 7 0 0 0-1.1 4c1.9-.1 3.3-.6 4.3-1.4 1-1 1.6-2.3 1.7-4.6-2.7.1-4 1-4.9 2z"/></svg>
                        <h1 class="text-4xl font-semibold text-black">120 pohon</h1>
                    </div>
                    <p class="text-gray-600">Lorem Ipsum</p>
                </div>
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <div class="flex items-center py-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mr-0.5 text-red-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sprout mr-2"><path d="M7 20h10"/><path d="M10 20c5.5-2.5.8-6.4 3-10"/><path d="M9.5 9.4c1.1.8 1.8 2.2 2.3 3.7-2 .4-3.5.4-4.8-.3-1.2-.6-2.3-1.9-3-4.2 2.8-.5 4.4 0 5.5.8z"/><path d="M14.1 6a7 7 0 0 0-1.1 4c1.9-.1 3.3-.6 4.3-1.4 1-1 1.6-2.3 1.7-4.6-2.7.1-4 1-4.9 2z"/></svg>
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    <p class="text-black font-semibold">pH</p>
                    <div class="flex items-center py-3">
                        ...
                        <h1 class="text-4xl font-semibold text-black">5,7</h1>
                    </div>
                    <p class="text-gray-600">pH Basa</p>
                </div>
